...
#define STRING_CONFIG_H_AUTHOR "(Beta)" // Who made the changes.
...
#define LPC_PINCFG_UART3_P4_28  // Changing Serial3 pins to a MKS WIFI connector
...
#define CUSTOM_MACHINE_NAME "Infitary"
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 100 * (X_MICROSTEPS / 16), 100 * (Y_MICROSTEPS / 16), 400 * (Z_MICROSTEPS / 16), 92.6 * (E0_MICROSTEPS / 16) }
 ...
 *                                      X, Y, Z [, I [, J [, K]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_ACCELERATION      { 2000, 2000, 100, 10000 } // old slow?
...
//
// RELOADED (T5UID1)
//  - Download https://github.com/Desuuuu/DGUS-reloaded/releases1
//  - Copy the downloaded DWIN_SET folder to the SD card.
//
